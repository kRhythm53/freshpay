...
func SetupRouter() *gin.Engine {
	...
	grp2 := r.Group("/users")
	{
		...
		grp2.POST("signin/otp/:phone_number",user_management.LoginByOTP)
		grp2.POST("signin/otp/verification",user_management.LoginByOTPVerification)
		grp2.POST("reset/password/:phone_number",user_management.ResetPasswordByOTP)
	...
	grp5 := r.Group("/admin")
	{
		...
		grp5.POST("signin/otp/:phone_number",admin_management.LoginByOTP)
		grp5.POST("signin/otp/verification",admin_management.LoginByOTPVerification)
		grp5.POST("reset/password/:phone_number",admin_management.ResetPasswordByOTP)
